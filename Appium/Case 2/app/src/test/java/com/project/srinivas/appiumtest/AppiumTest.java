...
public class AppiumTest {
    ...
    public void testFlow0() {
        ...
        //search for samsung s7 edge case
        driver.findElement(By.id("com.groupon:id/search_edittext")).sendKeys("samsung fast charger");
        wait.until(ExpectedConditions.presenceOfElementLocated(By
         .xpath("//android.widget.TextView[@TextView[@index='0']")));


        //click on preffered suggestion
        driver.findElement(By.xpath("//com.groupon:id/search_suggestions_list_item[@text='samsung fast charger']")).click();
        wait.until(ExpectedConditions.presenceOfElementLocated(By
       ...
       // driver.findElement(By.xpath("//android.widget.ImageView[@index='0']")).click();
        ...
        //enter the details
        //*******************change email every time you run***************************************
        driver.findElement(By.id("com.groupon:id/fragment_log_in_sign_up_name")).sendKeys("Chinnu chinn3");
        driver.findElement(By.id("com.groupon:id/fragment_log_in_sign_up_email")).sendKeys("email53@123.com");
        ...
        //click on cart
        WebElement cart= driver.findElement(By.id("com.groupon:id/shopping_cart_indicator"));
        cart.click();
        ...
        //click on cart
        driver.findElement(By.id("com.groupon:id/shopping_cart_indicator")).click();
